            ...
            {1, new Dictionary<byte, OpcodeCaller>()
                {
                  ...
                  { 0x6A, () => new Push(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.SXTBYTE)) },
                  { 0x6B, () => new  Mul(new ModRM(FetchNext(), ModRMSettings.SWAP), SIGNED | IMMEDIATE | SXTBYTE) },

                  { 0x70, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.O) },
                  { 0x71, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.NO) },
                  { 0x72, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.C) },
                  { 0x73, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.NC) },
                  { 0x74, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.Z) },
                  { 0x75, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.NZ) },
                  { 0x76, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.NA) },
                  { 0x77, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.A) },
                  { 0x78, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.S) },
                  { 0x79, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.NS) },
                  { 0x7A, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.P) },
                  { 0x7B, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.NP) },
                  { 0x7C, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.L) },
                  { 0x7D, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.GE) },
                  { 0x7E, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.LE) },
                  { 0x7F, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE), Condition.G) },
                  ...
                  { 0xEB, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ImmediateSettings.RELATIVE)) },
                  { 0xE9, () => new Jmp(new Immediate(RegisterCapacity.GP_DWORD, ImmediateSettings.RELATIVE)) },
