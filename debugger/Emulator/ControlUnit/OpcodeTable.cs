            ...
            {1, new Dictionary<byte, OpcodeCaller>()
                {
                  ...
                  { 0x50, () => new Push(new ImplicitRegister(XRegCode.A ), IMMEDIATE) },
                  { 0x51, () => new Push(new ImplicitRegister(XRegCode.C ), IMMEDIATE) },
                  { 0x52, () => new Push(new ImplicitRegister(XRegCode.D ), IMMEDIATE) },
                  { 0x53, () => new Push(new ImplicitRegister(XRegCode.B ), IMMEDIATE) },
                  { 0x54, () => new Push(new ImplicitRegister(XRegCode.SP), IMMEDIATE) },
                  { 0x55, () => new Push(new ImplicitRegister(XRegCode.BP), IMMEDIATE) },
                  { 0x56, () => new Push(new ImplicitRegister(XRegCode.SI), IMMEDIATE) },
                  { 0x57, () => new Push(new ImplicitRegister(XRegCode.DI), IMMEDIATE) },
                  { 0x58, () => new Pop (new ImplicitRegister(XRegCode.A ), IMMEDIATE) },
                  { 0x59, () => new Pop (new ImplicitRegister(XRegCode.C ), IMMEDIATE) },
                  { 0x5A, () => new Pop (new ImplicitRegister(XRegCode.D ), IMMEDIATE) },
                  { 0x5B, () => new Pop (new ImplicitRegister(XRegCode.B ), IMMEDIATE) },
                  { 0x5C, () => new Pop (new ImplicitRegister(XRegCode.SP), IMMEDIATE) },
                  { 0x5D, () => new Pop (new ImplicitRegister(XRegCode.BP), IMMEDIATE) },
                  { 0x5E, () => new Pop (new ImplicitRegister(XRegCode.SI), IMMEDIATE) },
                  { 0x5F, () => new Pop (new ImplicitRegister(XRegCode.DI), IMMEDIATE) },

                  { 0x63, () => new Movx(new ModRM(FetchNext(), ModRMSettings.SWAP), "MOVSXD", signExtend:true, RegisterCapacity.GP_DWORD) },
                  //67 prefix
                  { 0x68, () => new Push(new Immediate(RegisterCapacity.GP_DWORD)) }, // its always 32, weird
                  { 0x69, () => new  Mul(new ModRM(FetchNext(), ModRMSettings.SWAP), SIGNED | IMMEDIATE) },
                  { 0x6A, () => new Push(new Immediate(RegisterCapacity.GP_QWORD)) },
                  { 0x6B, () => new  Mul(new ModRM(FetchNext(), ModRMSettings.SWAP), SIGNED | IMMEDIATE | SXBYTE) },

                  { 0x70, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.O) },
                  { 0x71, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.NO) },
                  { 0x72, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.C) },
                  { 0x73, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.NC) },
                  { 0x74, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.Z) },
                  { 0x75, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.NZ) },
                  { 0x76, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.NA) },
                  { 0x77, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.A) },
                  { 0x78, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.S) },
                  { 0x79, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.NS) },
                  { 0x7A, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.P) },
                  { 0x7B, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.NP) },
                  { 0x7C, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.L) },
                  { 0x7D, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.GE) },
                  { 0x7E, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.LE) },
                  { 0x7F, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true), Condition.G) },
                  ...
                  { 0xE3, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE), Condition.RCXZ) },

                  { 0xEB, () => new Jmp(new Immediate(RegisterCapacity.GP_BYTE, ripRel:true)) },
                  { 0xE9, () => new Jmp(new Immediate(RegisterCapacity.GP_DWORD, ripRel:true)) },
