            ...
            {1, new Dictionary<byte, OpcodeCaller>()
                {
                  ...
                  { 0x90, () => new Nop() },
                  { 0x91, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.C )) },
                  { 0x92, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.D )) },
                  { 0x93, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.B )) },
                  { 0x94, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.SP )) },
                  { 0x95, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.BP )) },
                  { 0x96, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.SI )) },
                  { 0x97, () => new Xchg(new MultiRegisterHandle(XRegCode.A, XRegCode.DI )) },
