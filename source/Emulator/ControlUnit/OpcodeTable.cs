            ...
            {1, new Dictionary<byte, OpcodeCaller>()
                {
                  ...
                  { 0x08, () => new  Or(new ModRM(), BYTEMODE)},
                  { 0x09, () => new  Or(new ModRM()) },
                  { 0x0A, () => new  Or(new ModRM(ModRMSettings.SWAP), BYTEMODE)},
                  { 0x0B, () => new  Or(new ModRM(ModRMSettings.SWAP)) },
                  ...
                  { 0x10, () => new Add(new ModRM(), BYTEMODE,useCarry:true)},
                  { 0x11, () => new Add(new ModRM(), useCarry:true) },
                  { 0x12, () => new Add(new ModRM(ModRMSettings.SWAP), BYTEMODE, useCarry:true)},
                  { 0x13, () => new Add(new ModRM(ModRMSettings.SWAP), useCarry:true)},
                  ...
                  { 0x18, () => new Sub(new ModRM(), BYTEMODE,useBorrow:true)},
                  { 0x19, () => new Sub(new ModRM(), useBorrow:true) },
                  { 0x1A, () => new Sub(new ModRM(ModRMSettings.SWAP), BYTEMODE, useBorrow:true)},
                  { 0x1B, () => new Sub(new ModRM(ModRMSettings.SWAP), useBorrow:true)},
                  ...
                  { 0x20, () => new And(new ModRM(), BYTEMODE)},
                  { 0x21, () => new And(new ModRM()) },
                  { 0x22, () => new And(new ModRM(ModRMSettings.SWAP), BYTEMODE)},
                  { 0x23, () => new And(new ModRM(ModRMSettings.SWAP)) },
                  ...
                  { 0x28, () => new Sub(new ModRM(), BYTEMODE,useBorrow:false)},
                  { 0x29, () => new Sub(new ModRM(), useBorrow:false) },
                  { 0x2A, () => new Sub(new ModRM(ModRMSettings.SWAP), BYTEMODE, useBorrow:false)},
                  { 0x2B, () => new Sub(new ModRM(ModRMSettings.SWAP), useBorrow:false)},
                  ...
                  { 0x30, () => new Xor(new ModRM(), BYTEMODE)},
                  { 0x31, () => new Xor(new ModRM()) },
                  { 0x32, () => new Xor(new ModRM(ModRMSettings.SWAP), BYTEMODE)},
                  { 0x33, () => new Xor(new ModRM(ModRMSettings.SWAP)) },
                  ...
                  { 0x38, () => new Cmp(new ModRM(), BYTEMODE)},
                  { 0x39, () => new Cmp(new ModRM()) },
                  { 0x3A, () => new Cmp(new ModRM(ModRMSettings.SWAP), BYTEMODE)},
                  { 0x3B, () => new Cmp(new ModRM(ModRMSettings.SWAP)) },
                  ...
                  { 0x63, () => new Movx(new ModRM(ModRMSettings.SWAP), "MOVSXD", signExtend:true, RegisterCapacity.DWORD) },
                  { 0x68, () => new Push(new Immediate()) },
                  { 0x69, () => new  Mul(new ModRM(ModRMSettings.SWAP), SIGNED) },
                  ...
                  { 0x84, () => new Test(new ModRM(), BYTEMODE) },
                  { 0x85, () => new Test(new ModRM()) },
                  { 0x86, () => new Xchg(new ModRM(), BYTEMODE) },
                  { 0x87, () => new Xchg(new ModRM()) },

                  { 0x88, () => new Mov(new ModRM(), BYTEMODE) },
                  { 0x89, () => new Mov(new ModRM()) },
                  { 0x8A, () => new Mov(new ModRM(ModRMSettings.SWAP), BYTEMODE) },
                  { 0x8B, () => new Mov(new ModRM(ModRMSettings.SWAP))},

                  { 0x8D, () => new Lea(new ModRM(ModRMSettings.SWAP | ModRMSettings.HIDEPTR))},

                  { 0x8F, () => new Pop(new ModRM()) },
                  { 0x90, () => new Nop() },
                  ...
                  { 0xC6, () => new Mov(new DecodedCompound(new ModRM(ModRMSettings.EXTENDED), new Immediate()), BYTEMODE)},
                  { 0xC7, () => new Movx(new DecodedCompound(new ModRM(ModRMSettings.EXTENDED), new Immediate()), "MOV", true, RegisterCapacity.QWORD)},
            ...
            {2, new Dictionary<byte, OpcodeCaller>()
                {
                    ...
                    { 0x90, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.O) },
                    { 0x91, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.NO) },
                    { 0x92, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.C) },
                    { 0x93, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.NC) },
                    { 0x94, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.Z) },
                    { 0x95, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.NZ) },
                    { 0x96, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.NA) },
                    { 0x97, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.A) },
                    { 0x98, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.S) },
                    { 0x99, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.NS) },
                    { 0x9A, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.P) },
                    { 0x9B, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.NP) },
                    { 0x9C, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.L) },
                    { 0x9D, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.GE) },
                    { 0x9E, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.LE) },
                    { 0x9F, () => new Set(new ModRM(ModRMSettings.EXTENDED), Condition.G) },

                    { 0xAF, () => new Mul(new ModRM(ModRMSettings.SWAP), SIGNED)},

                    { 0xB6, () => new Movx(new ModRM(ModRMSettings.SWAP),"MOVZX", signExtend:false, desiredSourceSize:RegisterCapacity.BYTE)},
                    { 0xB7, () => new Movx(new ModRM(ModRMSettings.SWAP),"MOVZX", signExtend:false, desiredSourceSize:RegisterCapacity.WORD)},

                    { 0xBE, () => new Movx(new ModRM(ModRMSettings.SWAP),"MOVSX", signExtend:true, desiredSourceSize:RegisterCapacity.BYTE)},
                    { 0xBF, () => new Movx(new ModRM(ModRMSettings.SWAP),"MOVSX", signExtend:true, desiredSourceSize:RegisterCapacity.WORD)},
                }
            }
        };
